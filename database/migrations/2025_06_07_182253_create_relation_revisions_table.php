...
use App\Enums\RelationRevisionType;
...
return new class extends Migration
{
    ...
    {
        Schema::create('relation_revisions', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('type', Arr::pluck(RelationRevisionType::cases(), 'value'));
    ...
    {
        Schema::dropIfExists('relation_revisions');
    }
};
