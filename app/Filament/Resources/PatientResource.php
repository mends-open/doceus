...
class PatientResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Resources\PatientResource\Pages\ListPatients::route('/'),
            'create' => \App\Filament\Resources\PatientResource\Pages\CreatePatient::route('/create'),
            'edit' => \App\Filament\Resources\PatientResource\Pages\EditPatient::route('/{record}/edit'),
        ];
    }
