...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.providers.practitioners.driver' => 'string',
            'auth.providers.practitioners.model' => 'string',
            ...
            'auth.passwords.practitioners.provider' => 'string',
            'auth.passwords.practitioners.table' => 'string',
            'auth.passwords.practitioners.expire' => 'integer',
            'auth.passwords.practitioners.throttle' => 'integer',
            ...
            'filesystems.links./home/dominik/mends-open/doceus/public/storage' => 'string',
            ...
            'queue.encrypt' => 'boolean',
            'queue.encryption_key' => 'NULL',
            ...
            'sqid.length' => 'integer',
            'sqid.alphabet' => 'string',
            'sqid.alphabets.user' => 'string',
            'sqid.alphabets.organization' => 'string',
            'sqid.alphabets.appointment' => 'string',
            'sqid.alphabets.person' => 'string',
            'sqid.alphabets.patient' => 'string',
            'sqid.alphabets.practitioner' => 'string',
            'sqid.alphabets.location' => 'string',
            'sqid.alphabets.schedule' => 'string',
...
'auth.providers.users.driver','auth.providers.users.model','auth.providers.practitioners.driver','auth.providers.practitioners.model','auth.passwords.users.provider',
'auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.passwords.practitioners.provider','auth.passwords.practitioners.table',
'auth.passwords.practitioners.expire','auth.passwords.practitioners.throttle','auth.password_timeout','cache.default','cache.stores.array.driver',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/dominik/mends-open/doceus/public/storage','hashing.driver','hashing.bcrypt.rounds',
...
'queue.failed.table','queue.encrypt','queue.encryption_key','services.postmark.token','services.resend.key',
...
'session.partitioned','sqid.length','sqid.alphabet','sqid.alphabets.user','sqid.alphabets.organization',
'sqid.alphabets.appointment','sqid.alphabets.person','sqid.alphabets.patient','sqid.alphabets.practitioner','sqid.alphabets.location',
'sqid.alphabets.schedule','telescope.enabled','telescope.domain','telescope.path','telescope.driver',
...
'filament.app.auth.email-verification.prompt','filament.app.auth.email-verification.verify','filament.app.auth.email-change-verification.verify','filament.app.auth.email-change-verification.block-verification','filament.app.tenant.registration',
'filament.app.pages.dashboard','filament.app.resources.locations.index','filament.app.resources.locations.create','filament.app.resources.locations.edit','filament.app.resources.locations.schedules.index',
'filament.app.resources.locations.schedules.create','filament.app.resources.locations.schedules.edit','filament.app.resources.patients.index','filament.app.resources.patients.create','filament.app.resources.patients.edit',
'filament.app.resources.practitioners.index','filament.app.resources.practitioners.create','filament.app.resources.practitioners.edit','filament.app.resources.practitioners.schedules.index','filament.app.resources.practitioners.schedules.create',
'filament.app.resources.practitioners.schedules.edit','filament.app.tenant','horizon.stats.index','horizon.workload.index','horizon.masters.index',
...
'horizon.failed-jobs.show','horizon.retry-jobs.show','horizon.jobs.show','horizon.index','telescope','livewire.update','livewire.upload-file','livewire.preview-file','storage.local',);
...
'filament-panels::components.sidebar.group','filament-panels::components.sidebar.item','filament-panels::components.tenant-menu','filament-panels::components.theme-switcher.button','filament-panels::components.theme-switcher.index',
'filament-panels::components.topbar.database-notifications-trigger','filament-panels::components.topbar.item','filament-panels::components.unsaved-action-changes-alert','filament-panels::components.user-menu','filament-panels::livewire.global-search',
'filament-panels::livewire.sidebar','filament-panels::livewire.simple-user-menu','filament-panels::livewire.topbar','filament-panels::pages.page','filament-panels::pages.simple',
'filament-panels::resources.relation-manager','filament-panels::widgets.account-widget','filament-panels::widgets.filament-info-widget','filament-schemas::components.actions','filament-schemas::components.fieldset',
'filament-schemas::components.flex','filament-schemas::components.form','filament-schemas::components.fused-group','filament-schemas::components.grid','filament-schemas::components.image',
'filament-schemas::components.livewire','filament-schemas::components.section','filament-schemas::components.tabs','filament-schemas::components.tabs.tab','filament-schemas::components.text',
'filament-schemas::components.unordered-list','filament-schemas::components.wizard','filament-schemas::components.wizard.step','filament-tables::components.column-manager','filament-tables::components.columns.layout',
'filament-tables::components.filters','filament-tables::components.search-field','filament-tables::components.summary.index','filament-tables::components.summary.row','filament-tables::index',
...
'filament::components.dropdown.index','filament::components.dropdown.list.index','filament::components.dropdown.list.item','filament::components.fieldset','filament::components.icon',
...
'filament::components.toggle','horizon::layout','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','doceus.user.first_name',
'doceus.user.last_name','doceus.user.email','doceus.user.phone','doceus.user.language','doceus.user.pesel',
'doceus.auth.first_name','doceus.auth.last_name','doceus.auth.pesel','doceus.organization.label','doceus.organization.plural_label',
'doceus.organization.name','doceus.organization.type','doceus.organization_type.label','doceus.organization_type.individual','doceus.organization_type.entity',
'doceus.user_feature.is_medical_doctor','doceus.user_feature.is_medical_assistant','doceus.user_feature.is_dentistry_doctor','doceus.user_feature.is_intern_doctor','doceus.user_feature.is_resident_doctor',
'doceus.user_feature.is_medical_student','doceus.user_feature.is_dentistry_student','doceus.user_feature.is_psychology_student','doceus.user_feature.is_psychologist','doceus.user_feature.is_psychotherapist',
'doceus.user_feature.has_registered_practice','doceus.user_feature.is_healthcare_manager','doceus.user_feature.is_superadmin','doceus.user_feature.is_admin','doceus.user_feature.is_owner',
'doceus.user_feature.is_user','doceus.organization_feature.is_registered_practice','doceus.organization_feature.is_specialized_practice','doceus.organization_feature.is_medical_practice','doceus.organization_feature.is_dental_practice',
'doceus.organization_feature.is_group_medical_practice','doceus.organization_feature.is_medical_facility','doceus.feature_event.granted','doceus.feature_event.revoked','doceus.revision_type.created',
'doceus.revision_type.updated','doceus.revision_type.deleted','doceus.revision_type.restored','doceus.revision_type.force_deleted','doceus.language.en',
'doceus.language.pl','doceus.pesel.exact-eleven-digits','doceus.pesel.invalid','doceus.gender.label','doceus.gender.male',
'doceus.gender.female','doceus.gender.other','doceus.gender.unknown','doceus.practitioner_qualification.label','doceus.practitioner_qualification.general',
'doceus.practitioner_qualification.specialist','doceus.tag_color.label','doceus.tag_color.success','doceus.tag_color.warning','doceus.tag_color.danger',
'doceus.tag_color.info','doceus.tag_color.primary','doceus.tag_color.gray','doceus.repeat_pattern.label','doceus.repeat_pattern.none',
'doceus.repeat_pattern.weekly','doceus.is_blocking.label','doceus.slot_status.label','doceus.slot_status.free','doceus.slot_status.booked',
'doceus.slot_status.blocked','doceus.day_of_week.label','doceus.day_of_week.1','doceus.day_of_week.2','doceus.day_of_week.3',
'doceus.day_of_week.4','doceus.day_of_week.5','doceus.day_of_week.6','doceus.day_of_week.7','doceus.birth_date',
'doceus.id_number','doceus.settings','filament-actions::associate.single.label','filament-actions::associate.single.modal.heading','filament-actions::associate.single.modal.fields.record_id.label',
...
'filament-actions::delete.multiple.modal.actions.delete.label','filament-actions::delete.multiple.notifications.deleted.title','filament-actions::delete.multiple.notifications.deleted_partial.title','filament-actions::delete.multiple.notifications.deleted_partial.missing_authorization_failure_message','filament-actions::delete.multiple.notifications.deleted_partial.missing_processing_failure_message',
'filament-actions::delete.multiple.notifications.deleted_none.title','filament-actions::delete.multiple.notifications.deleted_none.missing_authorization_failure_message','filament-actions::delete.multiple.notifications.deleted_none.missing_processing_failure_message','filament-actions::detach.single.label','filament-actions::detach.single.modal.heading',
...
'filament-actions::force-delete.multiple.notifications.deleted_partial.title','filament-actions::force-delete.multiple.notifications.deleted_partial.missing_authorization_failure_message','filament-actions::force-delete.multiple.notifications.deleted_partial.missing_processing_failure_message','filament-actions::force-delete.multiple.notifications.deleted_none.title','filament-actions::force-delete.multiple.notifications.deleted_none.missing_authorization_failure_message',
'filament-actions::force-delete.multiple.notifications.deleted_none.missing_processing_failure_message','filament-actions::group.trigger.label','filament-actions::import.label','filament-actions::import.modal.heading','filament-actions::import.modal.form.file.label',
...
'filament-actions::restore.multiple.modal.heading','filament-actions::restore.multiple.modal.actions.restore.label','filament-actions::restore.multiple.notifications.restored.title','filament-actions::restore.multiple.notifications.restored_partial.title','filament-actions::restore.multiple.notifications.restored_partial.missing_authorization_failure_message',
'filament-actions::restore.multiple.notifications.restored_partial.missing_processing_failure_message','filament-actions::restore.multiple.notifications.restored_none.title','filament-actions::restore.multiple.notifications.restored_none.missing_authorization_failure_message','filament-actions::restore.multiple.notifications.restored_none.missing_processing_failure_message','filament-actions::view.single.label',
'filament-actions::view.single.modal.heading','filament-actions::view.single.modal.actions.close.label','filament-actions::notifications.throttled.title','filament-actions::notifications.throttled.body','filament-actions::global-search.0',
...
'filament-panels::register.0','filament-panels::global-search.field.label','filament-panels::global-search.field.placeholder','filament-panels::global-search.no_results_message','filament-panels::layout.direction',
...
'filament-panels::layout.logo.alt','filament-panels::dashboard.0','filament-panels::edit-tenant-profile.0','filament-panels::create-record.0','filament-panels::edit-record.0',
...
'filament-panels::block-email-change-verification-controller.0','filament-panels::email-change-verification-controller.0','filament-panels::disable.0','filament-panels::regenerate-recovery-codes.0','filament-panels::set-up.0',
'filament-panels::provider.0','filament-panels::verify-email-authentication.0','filament-panels::set-up-required-multi-factor-authentication.0','filament-panels::recovery-codes-modal-content.0','filament-panels::notice-of-email-change-request.0',
'filament-panels::error-notifications.title','filament-panels::error-notifications.body','filament-forms::components.builder.actions.clone.label','filament-forms::components.builder.actions.add.label','filament-forms::components.builder.actions.add.modal.heading',
...
'filament-forms::components.key_value.actions.reorder.label','filament-forms::components.key_value.fields.key.label','filament-forms::components.key_value.fields.value.label','filament-forms::components.markdown_editor.tools.attach_files','filament-forms::components.markdown_editor.tools.blockquote',
'filament-forms::components.markdown_editor.tools.bold','filament-forms::components.markdown_editor.tools.bullet_list','filament-forms::components.markdown_editor.tools.code_block','filament-forms::components.markdown_editor.tools.heading','filament-forms::components.markdown_editor.tools.italic',
'filament-forms::components.markdown_editor.tools.link','filament-forms::components.markdown_editor.tools.ordered_list','filament-forms::components.markdown_editor.tools.redo','filament-forms::components.markdown_editor.tools.strike','filament-forms::components.markdown_editor.tools.table',
'filament-forms::components.markdown_editor.tools.undo','filament-forms::components.modal_table_select.actions.select.label','filament-forms::components.modal_table_select.actions.select.actions.select.label','filament-forms::components.radio.boolean.true','filament-forms::components.radio.boolean.false',
...
'filament-forms::components.repeater.actions.expand_all.label','filament-forms::components.rich_editor.actions.attach_files.label','filament-forms::components.rich_editor.actions.attach_files.modal.heading','filament-forms::components.rich_editor.actions.attach_files.modal.form.file.label.new','filament-forms::components.rich_editor.actions.attach_files.modal.form.file.label.existing',
'filament-forms::components.rich_editor.actions.attach_files.modal.form.alt.label.new','filament-forms::components.rich_editor.actions.attach_files.modal.form.alt.label.existing','filament-forms::components.rich_editor.actions.custom_block.modal.actions.insert.label','filament-forms::components.rich_editor.actions.custom_block.modal.actions.save.label','filament-forms::components.rich_editor.actions.link.label',
'filament-forms::components.rich_editor.actions.link.modal.heading','filament-forms::components.rich_editor.actions.link.modal.form.url.label','filament-forms::components.rich_editor.actions.link.modal.form.should_open_in_new_tab.label','filament-forms::components.rich_editor.no_merge_tag_search_results_message','filament-forms::components.rich_editor.tools.attach_files',
'filament-forms::components.rich_editor.tools.blockquote','filament-forms::components.rich_editor.tools.bold','filament-forms::components.rich_editor.tools.bullet_list','filament-forms::components.rich_editor.tools.code_block','filament-forms::components.rich_editor.tools.custom_blocks',
'filament-forms::components.rich_editor.tools.h1','filament-forms::components.rich_editor.tools.h2','filament-forms::components.rich_editor.tools.h3','filament-forms::components.rich_editor.tools.italic','filament-forms::components.rich_editor.tools.link',
'filament-forms::components.rich_editor.tools.merge_tags','filament-forms::components.rich_editor.tools.ordered_list','filament-forms::components.rich_editor.tools.redo','filament-forms::components.rich_editor.tools.strike','filament-forms::components.rich_editor.tools.subscript',
'filament-forms::components.rich_editor.tools.superscript','filament-forms::components.rich_editor.tools.underline','filament-forms::components.rich_editor.tools.undo','filament-forms::components.select.actions.create_option.label','filament-forms::components.select.actions.create_option.modal.heading',
...
'filament-forms::components.text_input.actions.show_password.label','filament-forms::components.toggle_buttons.boolean.true','filament-forms::components.toggle_buttons.boolean.false','filament-forms::validation.distinct.must_be_selected','filament-forms::validation.distinct.only_one_must_be_selected',
...
'filament-notifications::database.modal.empty.description','filament-schemas::components.wizard.actions.previous_step.label','filament-schemas::components.wizard.actions.next_step.label','filament::button.0','filament::copyable.0',
'filament::modal.0','filament::pagination.0','filament-tables::query-builder.0','filament-tables::table.column_manager.heading','filament-tables::table.column_manager.actions.apply.label',
...
'SQID_ALPHABET','SQID_ALPHABET_USER','SQID_ALPHABET_ORGANIZATION','SQID_ALPHABET_APPOINTMENT','SQID_ALPHABET_PERSON',
'SQID_ALPHABET_PATIENT','SQID_ALPHABET_PRACTITIONER','SQID_ALPHABET_LOCATION','SQID_ALPHABET_SCHEDULE','PHP_CLI_SERVER_WORKERS',
